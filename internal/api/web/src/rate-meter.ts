...
class RateMeterElement extends HTMLElement {
    ...
    private readonly numsEl: HTMLSpanElement;
    private readonly fillEl: HTMLDivElement;
    private readonly usedEl: HTMLSpanElement;
    private readonly resetEl: HTMLSpanElement;
    ...
    private attrNum(name: string): number {
